...
La v0.48 mantiene las hifas finas de absorción unidas al tronco curvo visible durante todo su crecimiento. Los perfiles de desarrollador comienzan ahora con todas las mejoras a nivel cero y permiten subir o bajar gratuitamente cada mejora implementada en la tienda.
La v0.49 elimina el botón para alternar la unidad del cuartel y abre un menú cuadrado de unidades al pulsar Producir. Muestra las esporas expedicionarias desbloqueadas de básicas a avanzadas, con iconos de píxeles y costes totales dinámicos de nutrientes orgánicos y minerales; mantén Shift para producir 5 o Ctrl para producir 10. Los lotes se encolan de forma atómica, por lo que un pedido fallido no consume recursos.
