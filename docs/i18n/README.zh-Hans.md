...
目前版本是 Windows 早期原型 `0.48.0`，集中制作第一章“实验室微型培养”。玩家只控制真菌，延伸菌丝、吸收营养、进化能力，并指挥能够离开母体行动的远征孢子。v0.40 加入了符合兵种职责的安全指令系统，避免单位执行不适合自身特性的采集或攻击行动。
...
v0.46 将第一章完成报告、敌方悬停说明与战斗反馈、选兵 HUD、指令回执和兵营持续任务交互扩展为七语；旧存档中的中文撤退原因会迁移为稳定 ID，报告和悬停文字也会适配窄屏。
v0.47 将存档离线结算改为显示进度的分帧载入，并新增与普通进度隔离的开发者沙盒存档：可免费获得资源与升级、控制阶段，并在地图放置资源、细菌、己方核心、兵营、全部 10 类体外孢子、敌方真菌与守卫，以及生态事件。
v0.48 修复自动生长的细吸收菌丝在主干动画中脱离可见曲线的问题。开发者档现在从所有升级零级开始，商店中每项已实现升级都可免费增加或降低等级。
