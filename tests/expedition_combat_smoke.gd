...
func _run() -> void:
	...
	var expected_max := {"forager": 12.0, "carrier": 18.0, "chelator": 13.0, "scout": 8.0, "lytic": 10.0, "suppressor": 12.0, "piercer": 14.0, "coil": 11.0}
	...
	print("EXPEDITION_COMBAT_OK maxes=8 retreat=30% repair=0.080 death=true save=compatible offline=capped")
	game.queue_free()
	quit(0)
