...
func _run() -> void:
	...
	if not _check(game._goal_definitions().size() == 21 and game._goal_complete("bacterial_bloom") and game._goal_complete("bacteria_control") and game._goal_complete("first_structure") and game._goal_complete("bacteria_specialist") and game._goal_progress_text("suppression_field") == "0 / 1" and game._goal_progress_text("disperser_burst") == "0 / 8" and game._goal_progress_text("rival_colony") == "0 / 1" and game._goal_progress_text("rival_guard") == "0 / 5" and game._goal_progress_text("hypha_severing") == "0 / 3" and game._goal_progress_text("antifungal_lockdown") == "0 / 1" and game._goal_progress_text("sporefall_guard") == "0 / 3", "Long-term goals should include bacteria ecology, evolution, exploration, supply, suppression, event-response, suppressor-field, disperser-burst, rival-guard, rival-fungus, hypha-severing, antifungal-lockdown, and recurring-sporefall goals"):
		return
